...
export const writingTools: WritingTool[] = [
  {
    ...
    examples: [
      {
        bad: '同桌的铅笔盒里橡皮被咬坏了，数学书的卷角用透明胶带贴着，我却只写成一句话。',
  ...
  },
  {
    ...
    examples: [
      {
        bad: '我接过接力棒，握紧它然后冲出去，就用这样平铺直叙的话写完了。',
  ...
  },
  {
    ...
    examples: [
      {
        bad: '午后的阳光从窗帘缝里照进来，教室里只有笔尖的声音，还飘着粉笔灰的味道，我却写成了普通的一句话。',
  ...
  },
  {
    ...
    examples: [
      {
        bad: '别人打闹时他算数学题，大家聊游戏时他琢磨那道难题，我却只简单地说他很认真。',
  ...
  },
  {
    ...
    examples: [
      {
        bad: '他没有替我解题，只把笔递给我让我再试一次，我只写成一句“我懂得了友谊的珍贵”。',
  ...
  },
  {
    ...
    examples: [
      {
        bad: '灯光很亮，我吸气走上台，说了声“各位好”，句子却被我写得短促干巴。',
  ...
  },
  {
    ...
    examples: [
      {
        bad: '写作是记录生活和感受的方式。写下让你心动的瞬间、困惑、骄傲和热爱，因为你的故事值得被记住——我只是平静地陈述。',
